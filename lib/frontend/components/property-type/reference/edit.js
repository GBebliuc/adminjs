...
const Edit = props => {
  ...
  const selectedId = (record === null || record === void 0 ? void 0 : record.params[property.path]) || (record === null || record === void 0 ? void 0 : record.params[defaultPath[property.path]]);
