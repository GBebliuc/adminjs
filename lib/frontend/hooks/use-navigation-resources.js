...
function useNavigationResources(resources) {
  ...
  const enrichResource = (0, _react.useMemo)(() => (resource, icon) => {
    var _resource$navigation;

    return {
      href: resource.href || undefined,
      icon,
      isSelected: isSelected(resource.href, location),
      label: (resource === null || resource === void 0 ? void 0 : (_resource$navigation = resource.navigation) === null || _resource$navigation === void 0 ? void 0 : _resource$navigation.label) || resource.name,
      id: resource.id,
      onClick: event => {
        if (resource.href) {
  ...
  .reduce((memo, resource) => {
    var _resource$navigation2, _resource$navigation4;

    // in case resource has the same name as parent we namespace it wit "resource-""
    const key = ((_resource$navigation2 = resource.navigation) === null || _resource$navigation2 === void 0 ? void 0 : _resource$navigation2.name) || ['resource', resource.name].join('-');

    if (!resource.navigation || resource.navigation.name === null) {
      var _resource$navigation3;

      memo[key] = enrichResource(resource, (_resource$navigation3 = resource.navigation) === null || _resource$navigation3 === void 0 ? void 0 : _resource$navigation3.icon);
    } else if (memo[key] && memo[key].elements && (_resource$navigation4 = resource.navigation) !== null && _resource$navigation4 !== void 0 && _resource$navigation4.name) {
      memo[key].elements.push(enrichResource(resource));
    } else {
      var _resource$navigation5, _resource$navigation6;

      memo[key] = {
        elements: [enrichResource(resource)],
        label: (_resource$navigation5 = resource.navigation) === null || _resource$navigation5 === void 0 ? void 0 : _resource$navigation5.name,
        icon: (_resource$navigation6 = resource.navigation) === null || _resource$navigation6 === void 0 ? void 0 : _resource$navigation6.icon,
